...
@section('content')
    ...
    {{-- <form id="cart" action="{{ route('order.addToCart', $userData->id) }}" class="card p-4 mt-5" method="GET"> --}}
        <form action="{{ route('order.sewaEntry',$order['id']) }}" class="card p-4 mt-5" method="POST">
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center">
                ...
                <label style="width:12%;" for="userName" class="form-label">User Sewa
                    :</label>
                    {{-- <div class="col-sm-10"> --}}
                        <select id="userName" class="form-control form-select" style="width:88%" name="userName">
                    <!-- ... opsi-opsi produk ... -->
                    {{-- <option disabled hidden selected>Pilih</option> --}}
                    
                    
                    <option value="{{$idAuth}}" selected>{{$nameAuth}}</option>
