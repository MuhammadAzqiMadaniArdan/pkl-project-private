...
<hr>
    ...
    <p>Nama Produk Ke-2: {{ $secondProduct['name_product'] }}</p>
                (FREEZE) {{ $product['name'] }}
            </option>
                        </select> --}}
                ...
                <div class="mb-3" style="width: 100%; margin-left:30px;">
                    ...
                    <div class="col-sm-10">
                        <select id="name_product" class="form-control" name="name_product">
                            ...
                            @if($existingProducts['id'] == 6 && $i == 1 || $existingProducts['id'] == 6 && $i == 2 || $existingProducts['id'] == 10 && $i == 2 || $existingProducts['id'] == 10 && $i == 0)
                                <option value="{{ $colocationProducts[$i]['id'] }}" data-months="{{ $order['bulan'] }}"
                                    data-price="{{ $colocationProducts[$i]['price'] }}" data-access="{{ $orderStatus->access }}" data-type="{{ $colocationProducts[$i]['type'] }}">
                                    {{ $colocationProducts[$i]['name'] }}
                                </option>
                            @elseif($existingProducts['id'] == 9 && $i == 1 || $existingProducts['id'] == 9 && $i == 3 || $existingProducts['id'] == 11 && $i == 1 || $existingProducts['id'] == 11 && $i == 3)
                            <option value="{{ $colocationProducts[$i]['id'] }}" data-months="{{ $order['bulan'] }}"
                                    data-price="{{ $colocationProducts[$i]['price'] }}" data-access="{{ $orderStatus->access }}" data-type="{{ $colocationProducts[$i]['type'] }}">
                                    {{ $colocationProducts[$i]['name'] }}
                                </option>
...
{{-- <script>
    ...
    <script>
      ...
      <script>
        document.getElementById('months').addEventListener('change', function() {
            var selectedProductType = document.getElementById('name_product').options[document.getElementById('name_product').selectedIndex].getAttribute('data-type');
            var selectedMonth = this.value; // Mendapatkan nilai months yang dipilih oleh pengguna
            var ipDropdown = document.getElementById('IP');
