    ...
    <div class="jumbotron  mt-2" style="padding:0px;">
        <div class="container">
            ...
            <p class="lead"><a href="/dashboard">Home</a><a
                    href="{{ route('admin.order.entryData', $userData->id) }}">/DataPemesanan/</a><a
    ...
    @if ($validate == true)
        ...
        @endforeach --}}
            ...
            <div class="mb-3 row" hidden>
                ...
                <input type="text" name="userId" id="userId" class="form-control" style="width:88%"
                    value="{{ $userData->id }}">
            </div>
            {{-- @dd($userData->id) --}}
                            ...
                            @if ($product['type'] == 'dedicated')
                                @if ($product['stock'] == 0)
                                    <option value="{{ $product['id'] }}" data-price="{{ $product['price'] }}"
                                        data-type="{{ $product['type'] }}" disabled style="background: red;color:white;">
                                ...
                                @else
                                    <option value="{{ $product['id'] }}" data-price="{{ $product['price'] }}"
                                        ...
                                        @if ($product['type'] == 'dedicated' && $product['stock'] == 0)
                                            <p disbled style="background: red;color:white;">(Dedicated (HABIS)) {{ $product['name'] }}
                                            </p>
                                        @else
            ...
            <div class="mb-3" hidden>
                <div class="d-flex align-items-center">
                    <label style="width:12%;" for="ramDefault" class="form-label">ramDefault DDR 4 Tambahan (Sekali
                        Bayar)
                        :</label>
            ...
            <div class="mb-3">
                <div class="row align-items-center">
                    <div id="custom-field" style="display: none;">
                        <div class="col-sm-8">
                            <label for="custom_ram" class="form-label">Custom Ram Name(Masukkan Angka Saja
                                (perGB)):</label>
                        </div>
                        <div class="col-sm-9">
            ...
            <div class="mb-3 row">
                <label for="" class="col-sm-2 col-form-label w-100">Server Inventory:</label>
                {{-- <div class="col-sm-10">
                ...
                <table class="table table-bordered" id="dynamicAddRemove">
                    ...
                    <tr>
                        <td><input type="text" name="ramServer[]" placeholder="Enter ram" class="form-control"
                                id="ramServer" value="128" /></td>
                        ...
                        <td><input type="text" name="processor[]" placeholder="Enter processor" class="form-control"
                                id="cpu"
                                value="2 x Intel Xeon E5-2640v4 3.2 Ghz, Total 20 Core, 40 Thread/CPU                    " />
                        </td>
    ...
    @else
        <div class="card p-5 mt-5 mb-5">
            ...
            <div class="alert alert-danger mt-2 p-5">
                <h3 style="text-align: center;">Pesanan Client Bukan Produk Dengan Tipe Dedicated !</h3>
            </div>
    ...
    <script type="text/javascript">
        ...
        $("#add-btn").click(function() {
            ...
            $("#dynamicAddRemove").append(
                '<tr><td><input type="text" name="ramServer[]" placeholder="Enter ram" class="form-control" /></td><td><input type="text" name="disk[]" placeholder="Enter disk" class="form-control" /></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>'
            );
        });
    ...
    <script>
        ...
        document.getElementById('products').addEventListener('change', function() {
            ...
            if (productType) {
                ...
                cpu.value = "";
                ram.value = "";
                let cpuSet = ["2 x Intel Xeon E5-2640v4 @3.2 Ghz, Total 20 Core, 40 Thread/CPU",
                    "2 x Intel Xeon E5-2650v4 @2.9 Ghz, Total 24 Core, 48 Thread/CPU",
                    "2 x Intel Xeon E5-2690v4 @3.5 Ghz, Total 28 Core, 56 Thread/CPU",
                    "2 x Intel Xeon Gold 6138 @3.7 Ghz, Total 40 Core, 80 Thread/CPU"
                ];
                let ramSet = [96, 128];
