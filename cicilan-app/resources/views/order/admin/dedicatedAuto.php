...
@section('content')
    ...
    {{-- <form id="cart" action="{{ route('order.addToCart', $userData->id) }}" class="card p-4 mt-5" method="GET"> --}}
                        ...
                        @if ($data1[0]['type'] == 'dedicated')
                            @if ($productsGet['stock'] == 0)
                                <option value="{{ $data1[0]['id'] }}" data-price="{{ $data1[0]['price'] }}"
                                    ...
                                    <p>(Dedicated (HABIS)) {{ $data1[0]['name_product'] }}</p>
                                </option>
                            @else
                                <option value="{{ $data1[0]['id'] }}" data-price="{{ $data1[0]['price'] }}"
                                    data-type="{{ $data1[0]['type'] }} " data-bulan="{{$dataBulan[0]}}">
                                    @if ($data1[0]['type'] == 'dedicated' && $productsGet['stock'] == 0)
                                        <p disabled style="background: red;">(Dedicated (HABIS)) {{ $data1[0]['name_product'] }}</p>
                                    @else
                                        <p>(Dedicated) {{ $data1[0]['name_product'] }}</p>
                                    @endif
                                </option>
                            @endif
                        @endif
        ...
        <div class="range-wrap" style="width: 100%;">
            <input type="range" class="range" value="{{$data1[2]['qty']}}" min="0" max="12" step="1"
                name="SATA">
        ...
        <div class="range-wrap" style="width: 100%;">
            <input type="range" class="range" value="{{$data1[3]['qty']}}" min="0" max="4" step="1"
                name="NVME">
            <output class="bubble"></output>
        </div>
            ...
            <div class="d-flex align-items-center">
                ...
                <select id="ram" class="form-control form-select" style="width:88%" name="ram">
                    ...
                    @if($data1[1]['id'] == 17)
                        ...
                        <option value="64" selected>{{$data1[1]['name_product']}}</option>
                    @elseif($data1[1]['id'] == 16)
                        <option value="32" selected>{{$data1[1]['name_product']}}</option>
                        <option value="custom" selected>{{$data1[1]['name_product']}}</option>
                    @else
        ...
        <div class="mb-3">
            <div class="row align-items-center">
                <div id="custom-field" style="display: none;">
                    ...
                    <div class="col-sm-9">
                        <input type="number" name="custom_ram" id="custom_ram" class="form-control">
                        {{-- @for ($i = 1; $i < 513; $i++)
                        @if ($i % 8 == 0)
        ...
        <div class="mb-3">
            <div class="d-flex align-items-center">
                ...
                <select id="oS" class="form-control form-select" style="width:88%" name="oS">
                    <!-- ... opsi-opsi produk ... -->
                    {{-- <option disabled hidden selected>Pilih</option> --}}
                    <option value="{{$productEntry['entryData'][0][3]['system']}}" selected>{{$productEntry['entryData'][0][3]['system']}}</option>
            ...
            @foreach ($address['address'] as $address2)
                <div class="d-flex align-items-center">
                    ...
                    <select id="datacenter" class="form-control form-select" style="width:88%" name="datacenter">
                        ...
                        @if($productEntry['entryData'][0][2]["datacenter"] == "Bogor")
                        <option value="Bogor">Bogor ASNET
                            {{-- @else --}}
                            @else
