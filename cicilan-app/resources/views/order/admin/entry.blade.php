...
@section('content')
    ...
    <div class="jumbotron mt-2 mb-5" style="padding:0px;">
        <div class="container">
    ...
    <div class=
"modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle"
        aria-hidden="true">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <a type="button" class="btn btn-success"
                        href="{{ route('admin.order.createDedicated', $userData->id) }}" style="width: 49%">Dedicated</a>
                    <a type="button" class="btn btn-primary"
                        href="{{ route('admin.order.createColocation', $userData->id) }}" style="width: 49%">Colocation</a>
                </div>
        ...
        <table class="table-stripped w-100 table mt-3">
            ...
            <tbody>
                ...
                @php
                    ...
                    $invoiceDate = Carbon\Carbon::parse($users['created_at'])->formatLocalized('%y%m%d');
                    $data = [];
                    ...
                    @else
                        <td>
                            ...
                            @for ($i = 0; $i < $current; $i++)
                                ...
                                <li style="list-style-type:square;"><b>Bulan </b> :
                                    {{ $users['entryData'][$i][1]['bulan'] }} bulan</li>
                                <br>
                                @if ($users['entryData'][$i][2]['datacenter'] == 'Jakarta')
                                    <li style="list-style-type:square;"><b>Data Center </b> :
                                        {{ $users['entryData'][$i][2]['datacenter'] }} Matrix</li>
                                @else
                                    <li style="list-style-type:square;"><b>Data Center </b> :
                                        {{ $users['entryData'][$i][2]['datacenter'] }} ASNET</li>
                                @endif
                                @php
