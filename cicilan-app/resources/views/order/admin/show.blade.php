    ...
    <div class="card bg-light mt-5 p-5 mb-5" style="height: 100%">
        ...
        @if ($status2->attachment)
            ...
            @foreach ($status2->attachment as $item)
                <embed src={{ asset('attachments/' . $item) }} type="application/pdf" frameBorder="0" scrolling="auto"
                    height="900px" {{-- height="100%" --}} width="100%" {{-- padding="1200px 0px" --}}></embed>
                ...
                <br>
            @endforeach
            <a style="width: 20%;display:flex;justify-content:center;margin-left:40%;" href="{{ route('status.dedicated') }}"
