        ...
        <div class="mb-3 row">
            ...
            <table class="table table-bordered" id="dynamicAddRemove">
                ...
                <tr>
                    {{-- @dd($PO['inventory'][0][0]) --}}
                    @if ($getInvent !== 1)
                        <td><input type="text" name="ram[]" placeholder="Enter ram" class="form-control"
                                value="{{ $ramGet }}" /></td>
    ...
    <script type="text/javascript">
        ...
        $("#add-btn").click(function() {
            ...
            $("#dynamicAddRemove").append(
                '<tr><td><input type="text" name="ram[]" placeholder="Enter ram" class="form-control" value="0" /></td><td><input type="text" name="disk[]" placeholder="Enter disk" class="form-control" value="0" /></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>'
            );
        });
