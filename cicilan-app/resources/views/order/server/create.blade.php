    ...
    <form action="{{ route('detail_server.store', $order['id']) }}" method="post" class="card bg-light mt-5 p-5">
        ...
        <div class="mb-3 row">
            ...
            <table class="table table-bordered" id="dynamicAddRemove">
                ...
                <tr>
                    <td><input type="text" name="ram[]" placeholder="Enter ram" class="form-control" /></td>
    ...
    <script type="text/javascript">
        ...
        $("#add-btn").click(function() {
            ...
            $("#dynamicAddRemove").append(
                '<tr><td><input type="text" name="ram[]" placeholder="Enter ram" class="form-control" /></td><td><input type="text" name="disk[]" placeholder="Enter disk" class="form-control" /></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>'
            );
        });
