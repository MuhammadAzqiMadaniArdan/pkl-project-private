...
@section('content')
    ...
    <form action="{{ route('detail_server.store', $order['id']) }}" method="post" class="card bg-light mt-5 p-5">
        ...
        <div class="mb-3 row">
            ...
            <div class="col-sm-10">
                <input type="text" class="form-control" id="serialNumber" name="serialNumber" value="{{$PO['serialNumber']}}">
            </div>
        </div>
        <div class="mb-3 row">
      ...
      @endphp
        ...
        <table class="table table-bordered" id="dynamicAddRemove">
            ...
            <tr>
                ...
                <td><input type="number" name="ram[]" placeholder="Enter ram" class="form-control" value="{{ $ramGet }}"/></td>
                <td><input type="text" name="disk[]" placeholder="Enter disk" class="form-control" value="{{ $diskGet }}"/></td>
                @if($getType == 'dedicated')
                ...
                @endif
                @else
                <td><input type="number" name="ram[]" placeholder="Enter ram" class="form-control" value="0"/></td>
                <td><input type="text" name="disk[]" placeholder="Enter disk" class="form-control" value="0" /></td>
                @if($getType == 'dedicated')
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            ...
            <input type="date" name="entryDate" id="entryDate" class="form-control" style="width:100%;" value="{{$PO['entryDate']}}">
    ...
    <div class="mb-3 row">
        ...
        <div class="col-sm-10">
            <input type="text" class="form-control" id="serverLabel" name="serverLabel" value="{{$PO['serverLabel']}}">
        </div>
    </div>
...
<script type="text/javascript">
    ...
    $("#add-btn").click(function() {
        ...
        $("#dynamicAddRemove").append('<tr><td><input type="number" name="ram[]" placeholder="Enter ram" class="form-control" value="0" /></td><td><input type="text" name="disk[]" placeholder="Enter disk" class="form-control" value="0" /></td><td><button type="button" class="btn btn-danger remove-tr">Remove</button></td></tr>'
            );
    });
