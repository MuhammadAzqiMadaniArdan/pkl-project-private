    ...
    <div class="card mt-5 p-4">
        <form action="{{ route('register.account-create') }}" method="POST" class="mx-1 mx-md-4">
            ...
            <div class="row mt-3">
                ...
                <div class="col-sm-6 w-100 mb-3" style="margin-left:1%;">
                ...
                <div class="mb-3 mt-2 w-50" style="" >
                    ...
                    <div class="mb-3" hidden>
                        <input hidden type="text" name="role" id="role" class="form-control"
                            placeholder="Confirm Password" value="admin">
                    </div>
                </div>
                <hr>
                <button type="submit" class="btn btn-primary btn-lg btn-block mt-3 w-100" >Register</button>
                <div class="footer mt-3" style="font-weight:normal;">
                    Has Registered ? <a href={{ route('login') }}> Login</a>
                </div>
        </form>
