...

{
    ...
    return redirect()->route('order.admin.data', $prosesTambahData->id);
}
...
public function createDedicated($id)
    {
        ...
        return view('order.admin.dedicated', compact('products', 'bulan','userData'));
    }
    ...
    public function createColocation($id)
    {
        ...
        return view('order.admin.colocation', compact('products', 'bulan','userData'));
    }
